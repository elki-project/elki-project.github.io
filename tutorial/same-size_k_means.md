...
Since this is a K-means variant, we can use the base class [AbstractKMeans](/releases/current/javadoc/elki/clustering/kmeans/AbstractKMeans.html). Generating the standard methods, adding a logger and choosing the generics yields the following code blueprint.
